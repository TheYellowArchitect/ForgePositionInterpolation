...
{
	[GeneratedRPC("{\"types\":[[\"double\", \"Vector2\"]]")]
	[GeneratedRPCVariableNames("{\"types\":[[\"timestamp\", \"position\"]]")]
	public abstract partial class NetworkCommunicationControllerBehavior : NetworkBehavior
	{
		public const byte RPC_RECEIVE_HOST_POSITION = 0 + 5;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject.RegisterRpc("ReceiveHostPosition", ReceiveHostPosition, typeof(double), typeof(Vector2));
		...
		/// Vector2 position
		/// </summary>
		public abstract void ReceiveHostPosition(RpcArgs args);
